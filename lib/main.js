...
var LikeFM = {
    ...
    handshake: function() {
        ...
        $.get('https://like.fm/update2/',args,function(data,code) {
    ...
    sendTouchSignal: function(implicitFinish,callback) {
        var that = this;
        setTimeout(function(){
    ...
    initBetaDeezer: function(tabId) {
        chrome.tabs.executeScript(tabId,
            {file:"injectBetaDeezer.js"});
        this.initSupported(tabId);
    },
    initLive365: function(tabId) {
        chrome.tabs.executeScript(tabId,
            {file:"injectLive365.js"});
        this.initSupported(tabId);
    },    
    initSupported: function(tabId) {
        chrome.tabs.executeScript(tabId,
            {file:"lib/jquery.min.js",allFrames: true},function() {
                chrome.tabs.executeScript(tabId,
                    {file:"injectSupported.js",allFrames: true});
        });
    }
};
